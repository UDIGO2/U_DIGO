package com.ohgiraffers.udigo.crud.configuration;
...
@ComponentScan(basePackages = "com.ohgiraffers.udigo.crud")
// 지정된 패키지(com.ohgiraffers.crud)를 스캔하여 MyBatis 매퍼 인터페이스를 검색 및 등록.
// 여기서는 "Mapper.class"라는 어노테이션이 있는 클래스를 검색.
@MapperScan(basePackages = "com.ohgiraffers.udigo.crud", annotationClass = Mapper.class)
